...
- (void)updateScoreLabels {
    self.player1Score.text=[NSString stringWithFormat:@"Player 1:      %ld",self.players[0].score];
    self.player2Score.text=[NSString stringWithFormat:@"Player 2:      %ld",self.players[1].score];
}
...
- (void)updatePlayerLivesLabels {
    self.player1Lives.text = [NSString stringWithFormat:@"Player 1:      %ld",self.players[0].numberOfLives];
    self.player2Lives.text=[NSString stringWithFormat:@"Player 2:      %ld",self.players[1].numberOfLives];
}
